    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Configure security, notifications, and landlord portal preferences.
        </p>
      </div>
      ...
      <Card className="rounded-3xl border-border/80 bg-card p-12 text-center shadow-md">
        <div className="max-w-md mx-auto space-y-3">
          ...
          <h3 className="text-xl font-bold text-foreground">Landlord Settings</h3>
          <p className="text-xs text-muted-foreground">
            Account preferences and notification settings can be updated here.
          </p>
        </div>
      </Card>
    </div>
